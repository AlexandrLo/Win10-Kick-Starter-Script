...
# Install chocolatey and packages from Packages.config
Function InstallChocoWithPackages {
	...
	Write-Output "Installing Packages from $scriptPath\Packages.config..."
	choco install "$scriptPath\Packages.config" --confirm --acceptlicense
}

# Uninstall chocolatey with all packages
# WARNING!! This will remove Chocolatey and all packages, software, 
# and configurations in the Chocolatey Installation folder from your machine. 
# Everything will be GONE. This is very destructive. DO NOT RUN this tweak unless 
# you completely understand what the intention of this tweak is and are good with it.
# If you mess something up, we cannot help you fix it.
# Seriously, this tweak may destroy your machine and require a rebuild. 
# It may have varied results on different machines in the same environment. 
# Think twice before running this.
Function UninstallChocoWithPackages {
...
Function InstallKMSActivation {
	...
	& $scriptPath\online-kms\Activate.cmd /u

	Write-Output "Creating activation and renewal task..."
	& $scriptPath\online-kms\Renewal_Setup.cmd /rat
}
...
Function UninstallKMSActivation {
	...
	& $scriptPath\online-kms\Uninstall.cmd /u
}
